...
"""
Plot EA progress from a CSV with commented header and variable-length 'Cycle' column.

Expected CSV shape (example):
# Student number: r1072969
...
def main():
    parser = argparse.ArgumentParser(description="Plot EA progress from r1072969.csv")
    parser.add_argument("--csv", default="r1072969.csv", help="Path to the CSV file")
